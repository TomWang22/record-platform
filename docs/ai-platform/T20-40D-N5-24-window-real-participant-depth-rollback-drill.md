# T20.40D — N=5 24-window real-participant depth rollback drill
...
```text
pre-ui gate: keyword / keyword_default
UI enroll: PASS
enrolled gate: hybrid_canary / preview_opt_in
UI revoke: PASS
post-ui gate: keyword / keyword_default
```

The UI flow was driven through `/insights` without creating or staging a Playwright test artifact.
