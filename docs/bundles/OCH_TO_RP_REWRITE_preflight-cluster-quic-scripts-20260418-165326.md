# OCH → RP rewrite scan: `preflight-cluster-quic-scripts-20260418-165326`

**Staging (read-only scan):** `/Users/tom/bundle-staging/preflight-cluster-quic-scripts-20260418-165326`
