# OCH → RP rewrite scan: `preflight-cluster-quic-scripts-20260418-165415`

**Staging (read-only scan):** `/Users/tom/bundle-staging/preflight-cluster-quic-scripts-20260418-165415`
...
**Hits:** 371 (capped per file in scanner)
...
**Hits:** 272 (capped per file in scanner)
...
**Hits:** 111 (capped per file in scanner)
