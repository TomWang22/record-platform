# OCH → RP rewrite scan: `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410`

**Staging (read-only scan):** `/Users/tom/bundle-staging/record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410`
...
**Hits:** 443 (capped per file in scanner)

- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/Caddyfile`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/Makefile`
  ...
  - L1039: `bash $(SCRIPTS)/setup-full-off-campus-housing-stack.sh`
  - L1044: `bash $(SCRIPTS)/setup-full-off-campus-housing-stack.sh`
  - L1051: `PREFLIGHT_PHASE_D_TAIL_LAB=0 SKIP_COLIMA=1 bash $(SCRIPTS)/setup-full-off-campus-housing-stack.sh`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/README-BUNDLE.md`
  - L7: `Every default **`off-campus-housing-tracker`** namespace string in this tree was rewritten to **`record-platform`** (YAML, shell, TS/JS where it appeared). **Edge hostname** **`off-campus-housing.t…`
  - L54: `Follow **Off-Campus-Housing-Tracker** upstream license.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/README.txt`
  - L18: `Expected artifacts (local only): `dev-root.pem`, `dev-root.key`, `off-campus-housing.test.{crt,key}`,`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/SELF_BUILT_SERVICE_MESH.md`
  - L26: `**`off-campus-housing.test`** in edge scripts and Playwright is **not** renamed in this bundle. Point **`E2E_API_BASE`** and DNS to your Record Platform edge hostname.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/docker/caddy-with-tcpdump/Dockerfile`
  - L5: `# k3d: k3d image import caddy-with-tcpdump:dev -c off-campus-housing-tracker`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/docker/caddy-with-tcpdump/README.md`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/docker/envoy-with-tcpdump/Dockerfile`
  - L4: `# k3d: k3d image import envoy-with-tcpdump:dev -c off-campus-housing-tracker`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/app-config.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/analytics.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/analytics";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/booking.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/booking";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/common.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/common";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/events/auth.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/auth";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/events/envelope.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/events/messaging/v1/messaging_events.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing/proto/events/messaging/v1";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/listings.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/listings";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/media.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/media";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/messaging.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing/proto/messaging/v1";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/notification.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/notification";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/proto/trust.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/trust";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/envoy-test/deploy.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/envoy-test/envoy.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/nginx/nginx.conf`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/grafana-deploy.yaml`
  - L44: `value: https://off-campus-housing.test/grafana/`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/webapp/deploy.yaml`
  - L37: `value: "https://off-campus-housing.test"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/caddy-h3-configmap.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/caddy-h3-deploy-loadbalancer.yaml`
  - L88: `secretName: off-campus-housing-local-tls`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/caddy-h3-deploy.yaml`
  - L98: `secretName: off-campus-housing-local-tls`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/ingress-nginx-envoy.yaml`
  ...
  - L309: `sni: off-campus-housing.test`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/overlays/dev/ingress-grpc.yaml`
  - L23: `- off-campus-housing.test`
  - L24: `secretName: off-campus-housing-local-tls`
  - L26: `- host: off-campus-housing.test`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/overlays/dev/ingress-privacy-terms.yaml`
  - L29: `# Specific rule for off-campus-housing.test`
  - L30: `- host: off-campus-housing.test`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/overlays/dev/ingress.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/overlays/prod/caddy-rolling-update.yaml`
  - L105: `secretName: off-campus-housing-local-tls`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/package.json`
  - L52: `"setup:full-stack": "bash scripts/setup-full-off-campus-housing-stack.sh",`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/common.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/common";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/analytics.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/analytics";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/auth.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/auth";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/booking.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/booking";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/envelope.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/listing.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/listing";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/media.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/media";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/messaging.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/messaging";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/messaging/v1/messaging_events.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing/proto/events/messaging/v1";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/notification.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/notification";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/proto/events/trust.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/trust";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/apply-metallb-pool-colima.sh`
  - L48: `echo "Then: curl -k --http3 https://$ext_ip/_caddy/healthz  (or add $ext_ip off-campus-housing.test to /etc/hosts)"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/build-and-load-auth-service.sh`
  - L44: `say "Done. Deploy with: kubectl apply -k infra/k8s/base/auth-service (ensure namespace off-campus-housing exists)."`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/build-k6-http3.sh`
  - L92: `say "  $INSTALL_DIR/k6-http3 run -e BASE_URL=https://off-campus-housing.test scripts/load/k6-http3-complete.js"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/check-all-pods-and-tls.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/generate-kafka-ci-tls.sh`
  - L28: `-subj "/CN=och-kafka-ci-ca/O=off-campus-housing-ci" \`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/verify-quic-hostname-invariant.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/compare-h2-h3-headers.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/deploy-dev.sh`
  - L40: `LEAF_TLS_SECRET="${LEAF_TLS_SECRET:-off-campus-housing-local-tls}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/dev-generate-certs.sh`
  ...
  - … *1 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/diagnose-k6-edge-connectivity.sh`
  - L14: `HOST="${EDGE_HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/enhanced-adversarial-tests.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-caddy-envoy-strict-tls.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-colima-metallb-for-l2.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-edge-hosts.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-strict-tls-mtls-preflight.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/generate-envoy-client-cert.sh`
  - L3: `# Backends expect a client identity; the edge leaf (off-campus-housing.test) is not a service identity.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k6-chaos-test.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k6-exec-strict-edge.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/COHERENT_ANALYSIS.md`
  - L29: `1. Prove **TLS + SNI** (`off-campus-housing.test`) and **HTTP/2** to Caddy.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/edge-test-url.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/ensure-och-grpc-certs.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/grpc-http3-health.sh`
  - L14: `local host="${HOST:-off-campus-housing.test}"`
  - L73: `local grpc_authority="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/http3.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/packet-capture-v2.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/packet-capture.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/protocol-verification.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/trust-dev-root-ca-macos.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load-caddy-image-colima.sh`
  - L3: `# Strict TLS/mTLS: Caddy uses off-campus-housing-local-tls + dev-root-ca in ingress-nginx (from strict-tls-bootstrap).`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-analytics-daily-smoke.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-analytics-listing-feel-smoke.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-find-max-rps-http3.js`
  - L17: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L18: `const BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-http3-complete.js`
  - L60: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L62: `const BASE_URL = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-http3-toolchain.js`
  - L58: `const BASE_URL = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
  - L60: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-limit-test-comprehensive.js`
  - L38: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L39: `const BASE_URL = __ENV.BASE_URL || 'https://off-campus-housing.test';`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-listings-health.js`
  - L20: `: "https://off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-listings.js`
  - L9: `const rawBase = (__ENV.BASE_URL || "https://off-campus-housing.test").replace(/\/$/, "");`
  - L22: `const host = __ENV.HOST || "off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-media-upload.js`
  - L13: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-messaging-direct-message.js`
  - L6: `*   BASE_URL          — https://off-campus-housing.test (default)`
  - L25: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-messaging-e2e.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-messaging-flow.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-messaging-limit-finder.js`
  - L12: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-messaging.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-reads.js`
  - L7: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-spam-test.js`
  - L15: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-strict-edge-tls.js`
  - L9: `* https://off-campus-housing.test so `k6 run scripts/load/k6-*.js` works from repo root.`
  - L15: `: "https://off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/run-k6-all-services.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/run-k6-phases.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/perf/run-all-k6-load-report.sh`
  - L10: `#   BASE_URL              default https://off-campus-housing.test`
  - L25: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/perf/run-k6-cross-service-isolation.sh`
  - L36: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/perf/run-preflight-phase-d-tail-lab.sh`
  - L60: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/protocol/full-edge-transport-validation.sh`
  - L23: `export HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/protocol/test-service-protocol.sh`
  - L26: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/reissue-ca-and-leaf-load-all-services.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-caddy.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rotation-suite.sh`
  ...
  - L1692: `log_info "Certificate verified above: issuer = dev CA (CN=dev-root-ca, O=record-platform); subject = CN=off-campus-housing.test."`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-all-test-suites.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-demo-network-preflight.sh`
  - L42: `export HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-housing-k6-edge-smoke.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-k6-chaos.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-playwright-e2e-preflight.sh`
  - L10: `#   E2E_API_BASE           — must be https (default https://off-campus-housing.test)`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - L231: `#   Preconditions: PR1 merged; off-campus-housing.test + certs/dev-root.pem; kubectl get pods -n record-platform.`
  ...
  - L1693: `# 3a. Reissue CA + leaf first (dev-root-ca / off-campus-housing-local-tls, CA/Caddy match). KAFKA_SSL=1 persists CA key for Kafka.`
  - L1725: `ok "CA and leaf both rotated (dev-root-ca, off-campus-housing-local-tls, service-tls); certs/dev-root.pem is single source of truth"`
  ...
  - … *7 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-transport-study-experiments.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run_auth_pgbench_sweep.sh`
  - L21: `-n, --namespace NS       Kubernetes namespace (default: off-campus-housing)`
  - L57: `NS="off-campus-housing"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run_pgbench_sweep.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/setup-full-off-campus-housing-stack.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/setup-lb-ip-host-access.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/setup-new-colima-cluster.sh`
  - L138: `say "One-shot (idiot-proof): ./scripts/setup-full-off-campus-housing-stack.sh — see docs/RUN_PIPELINE_ORDER.md"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/setup-tls-and-edge.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/smoke-services.sh`
  - L7: `HOST="${HOST:-off-campus-housing.test}"`
  - L45: `# Ensure host resolves (optional: add off-campus-housing.test to /etc/hosts if needed)`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/smoke-test-dev.sh`
  - L4: `#   BASE_URL=https://off-campus-housing.test  (default from PORT/LB)`
  - L11: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/strict-tls-bootstrap.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-auth-service.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-booking-http2-http3.sh`
  - L11: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-full-chain-with-rotation.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-grpc-http2-http3.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- … *39 more paths*
...
**Hits:** 324 (capped per file in scanner)
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-grpc-http2-http3.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-http2-http3-strict-tls.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-lb-coordinated.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-listings-http2-http3.sh`
  - L17: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-messaging-service-comprehensive.sh`
  - L20: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-microservices-http2-http3-enhanced.sh`
  - L21: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-microservices-http2-http3-housing.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-packet-capture-standalone.sh`
  - L25: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/test-tls-mtls-comprehensive.sh`
  - L19: `HOST="${HOST:-off-campus-housing.test}"`
  - L142: `grpc_authority="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/transport/http3-concurrent-curl-stress.sh`
  - L5: `#   OCH_H3_URL=https://off-campus-housing.test/api/healthz \`
  - L14: `URL="${OCH_H3_URL:-https://off-campus-housing.test/api/healthz}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-caddy-grpc-routing.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-caddy-http3-in-cluster.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-caddy-strict-tls-in-cluster.sh`
  - L8: `#   2. Creates a temporary Pod with curl image and CA mounted; runs curl with --cacert and Host: off-campus-housing.test.`
  - L22: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-caddy-strict-tls.sh`
  - L18: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-db-and-cache-comprehensive.sh`
  - L112: `HOST="${HOST:-off-campus-housing.test}"`
  - L158: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-http3-edge.sh`
  - L6: `#   TARGET=https://off-campus-housing.test  (default)`
  - L29: `TARGET="${TARGET:-https://off-campus-housing.test}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-metallb-and-traffic-policy.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-preflight-edge-routing.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/webapp-playwright-strict-edge.sh`
  - L7: `#   E2E_API_BASE   — https only (default https://off-campus-housing.test); :4020 / http localhost rejected`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/common/src/grpc-clients.ts`
  - L76: `return "off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/README.md`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/e2e/analytics-api.spec.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/e2e/helpers.ts`
  - L5: `const DEFAULT_E2E_EDGE = "https://off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/lib/config.ts`
  - L3: `* - If NEXT_PUBLIC_API_BASE is set: browser calls that origin (e.g. https://off-campus-housing.test).`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/playwright.config.ts`
  - L3: `const DEFAULT_E2E = "https://off-campus-housing.test";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/playwright.global-setup.ts`
...
**Hits:** 595 (capped per file in scanner)
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/analytics-service/deploy.yaml`
  - L139: `secretName: och-service-tls`
  - L149: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/api-gateway/deploy.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/auth-service/deploy.yaml`
  - L165: `secretName: och-service-tls`
  - L175: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/booking-service/deploy.yaml`
  - L141: `secretName: och-service-tls`
  - L151: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/listings-service/deploy.yaml`
  - L151: `secretName: och-service-tls`
  - L161: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/media-service/deploy.yaml`
  - L64: `- name: och-service-tls`
  - L117: `- name: och-service-tls`
  - L119: `secretName: och-service-tls`
  - L129: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/messaging-service/deploy.yaml`
  - L165: `secretName: och-service-tls`
  - L176: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/notification-service/deploy.yaml`
  - L139: `secretName: och-service-tls`
  - L149: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/alertmanager-slo-route-example.yaml`
  - L12: `name: alertmanager-och-slo-example`
  - L34: `channel: "#och-slo-warning"`
  - L42: `channel: "#och-slo-critical"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/grafana-dashboard-auth-outbox.yaml`
  - L13: `"uid": "och-auth-outbox",`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/grafana-dashboard-providers.yaml`
  - L11: `- name: och-file`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/grafana-dashboards-transport.yaml`
  - L10: `och-transport-edge.json: |`
  - L108: `"uid": "och-transport-edge",`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/grafana-dashboards.yaml`
  - L107: `"uid": "och-microservices-overview",`
  - L176: `"uid": "och-distributed-tracing",`
  - L269: `"uid": "och-housing-uptime",`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/kustomization.yaml`
  - L10: `- prometheus-rules-och-slo.yaml`
  - L27: `#   och-slo-prometheusrule.yaml     — Prometheus Operator PrometheusRule`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/och-slo-prometheusrule.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/prometheus-deploy.yaml`
  - L12: `- /etc/prometheus/rules/och-slo.yml`
  - L125: `name: prometheus-rules-och-slo`
  - L127: `- key: och-slo.yml`
  - L128: `path: rules/och-slo.yml`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/observability/prometheus-rules-och-slo.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/trust-service/deploy.yaml`
  - L135: `secretName: och-service-tls`
  - L145: `secretName: och-kafka-ssl-secret`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/kafka-certs/README.md`
  - L47: `After Kafka and `och-kafka-ssl-secret` exist:`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/kafka-certs/kafka-tls-preflight-job.yaml`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/aggressive-cleanup-replicasets.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/apply-och-messaging-and-restart.sh`
  - L3: `# Prereq: OCH secrets exist (och-service-tls, och-kafka-ssl-secret).`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/assert-kafka-integration-cluster.mjs`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/bring-up-external-infra.sh`
  - L10: `#   ./scripts/recycle-och-postgres-compose.sh`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/build-housing-images-k3s.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/delete-kafka-event-topics.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/start-kafka-tls-ci.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/verify-housing-grpc-matrix.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/colima-edge-sysctl-tuning.sh`
  - L6: `# Persist: create /etc/sysctl.d/99-och-edge.conf with the same keys (distribution-specific).`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/colima-patch-app-config-db-host-to-gateway.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/create-kafka-event-topics-k8s.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/create-kafka-event-topics.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/dev-onboard-local.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/dev-onboard-zero-trust-preflight.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/diagnose-och-deployment.sh`
  - L3: `# Usage: ./scripts/diagnose-och-deployment.sh media-service`
  - L4: `#        ./scripts/diagnose-och-deployment.sh auth-service`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-all-services-tls.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-housing-cluster-secrets.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-strict-tls-mtls-preflight.sh`
  ...
  - … *2 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/install-metallb-colima.sh`
  - L124: `if ! och_assert_metallb_pool_coherent "$METALLB_POOL"; then`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k8s-rollout-och-ordered.sh`
  - L3: `# Usage: ./scripts/k8s-rollout-och-ordered.sh`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-refresh-tls-from-lb.sh`
  - L2: `# Regenerate kafka-ssl-secret (and och-kafka-ssl-secret) with SANs that include current`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-rolling-restart.sh`
  - L36: `if ! och_kafka_kraft_quorum_ok "$NS"; then`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-ssl-from-dev-root.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-tls-guard.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-tls-rotate-atomic.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/ensure-colima-docker-context.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/grpc-utils.sh`
  - L7: `och_housing_ns() {`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/kafka-broker-sans.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/kafka-kraft-quorum-ok.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/metallb-subnet-guard.sh`
  ...
  - … *1 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/och-housing-docker-services-default.sh`
  - L2: `# transport-watchdog: image only; rollouts map to deploy/api-gateway (see rebuild-och-images-and-rollout.sh).`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/och-kafka-event-topics-from-proto.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/och-sequential-rollout.sh`
  - L8: `#     och_kubectl() { kctl "$@"; }`
  ...
  - … *1 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/patch-kafka-external-host.sh`
  - L44: `RAW=$(kubectl run och-resolve-kafka-host --rm -i --restart=Never --image=busybox:1.36 -n record-platform -- \`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/perf/build-canonical-bundle.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/preflight-kafka-k8s-rollout.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rebuild-all-housing-images-k3s.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rebuild-och-images-and-rollout.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rebuild-traffic-control-stack.sh`
  - L11: `exec "$ROOT/scripts/rebuild-och-images-and-rollout.sh"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/recycle-och-postgres-compose.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/restore-external-postgres-from-backup.sh`
  - L44: `och_terminate_db_sessions() {`
  - L58: `och_terminate_db_sessions "$port" "$db"`
  - L66: `och_terminate_db_sessions "$port" "$db"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-deferred-after-kafka-tls.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-restart-och-after-pool-tuning.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-restart-och-full-stack.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - … *10 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/service-tls-alias-guard.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/slo/check-error-budget.js`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/tls-k8s-secrets-expiry.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/validate-kafka-stack-contract.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-deletion-flow.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-cluster.sh`
  ...
  - … *1 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-event-topic-partitions.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-kraft-e2e.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-tls-sans.sh`
  - L104: `done < <(och_kafka_emit_san_verify_dns_specs "$NS" "$REPLICAS")`
  - L120: `done < <(och_kafka_metallb_external_lb_ips_lines "$NS" "$REPLICAS")`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-network-coherence.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-proto-events-topics.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-proto-topic-alignment.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/wait-for-all-services-ready.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/wait-for-docker-compose-kafka-strict-ready.sh`
  - L6: `#   REPO_ROOT, ENV_PREFIX (default dev), OCH_KAFKA_TOPIC_SUFFIX (optional)`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/booking-service/README.md`
  ...
  - L31: `This sets **`OCH_INTEGRATION_KAFKA_FROM_K8S_LB=1`** (legacy alias: **`BOOKING_IT_KAFKA_FROM_K8S_LB=1`**), discovers **`kafka-0-external` … `kafka-2-external`** LoadBalancer IPs in **`record-platfor…`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/booking-service/package.json`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/booking-service/vitest.integration.config.mts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/booking-service/vitest.integration.kafka-env.ts`
  - L3: `* See monorepo docs / booking README for OCH_INTEGRATION_KAFKA_FROM_K8S_LB and TLS layout.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/common/src/grpc-server-credentials.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/common/src/kafka-vitest-cluster.ts`
  ...
  - L8: `*   - OCH_INTEGRATION_K8S_NAMESPACE / BOOKING_IT_K8S_NAMESPACE / HOUSING_NS — kubectl namespace (default record-platform)`
  ...
  - … *10 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/common/src/kafka.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/listings-service/README.md`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/listings-service/package.json`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/listings-service/vitest.integration.config.mts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/tests/system/listing-analytics.contract.test.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/tools/kafka-contract/src/index.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/tools/kafka-contract/src/topicBuilder.ts`
  - L2: `* Match scripts/lib/och-kafka-event-topics-from-proto.sh + ochKafkaTopicIsolationSuffix().`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/vitest.system.config.mts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/Dockerfile`
  - L2: `#   docker build -f webapp/Dockerfile -t och-webapp .`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/app/booking/page.tsx`
  - L17: `const LAST_BOOKING_KEY = "och_last_booking_id";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/app/community/page.tsx`
  - L39: `window.addEventListener("och-auth-change", syncAuth);`
  - L42: `window.removeEventListener("och-auth-change", syncAuth);`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/components/ClientChrome.tsx`
  - L18: `window.addEventListener("och-auth-change", sync);`
  - L19: `return () => window.removeEventListener("och-auth-change", sync);`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/components/MessagingSidebar.tsx`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/e2e/system-integrity.spec.ts`
...
**Hits:** 57 (capped per file in scanner)
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/api-gateway/service.yaml`
  - L11: `port: 4020`
  - L12: `targetPort: 4020   # must match container listen port (GATEWAY_PORT / default 4020)`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/config/app-config.yaml`
  - L19: `GATEWAY_PORT: "4020"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/haproxy/configmap.yaml`
  - L8: `# Off-Campus Housing Tracker: proxy to api-gateway only (Caddy → HAProxy → gateway :4020).`
  - L50: `server api api-gateway.record-platform.svc.cluster.local:4020 check maxconn 4000 init-addr none resolvers k8s`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/base/haproxy/haproxy.cfg`
  - L37: `server api api-gateway.record-platform.svc.cluster.local:4020 check init-addr none resolvers k8s`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/caddy-h3-configmap.yaml`
  - L121: `reverse_proxy http://api-gateway.record-platform.svc.cluster.local:4020 {`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/overlays/dev/ingress.yaml`
  - L30: `number: 4020`
  - L38: `number: 4020`
  - L56: `number: 4020`
  - L63: `number: 4020`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/smoke-api-gateway.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/edge-readiness-gate.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k6/k6-smoke-gateway.js`
  - L15: `"http://api-gateway.record-platform.svc.cluster.local:4020";`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/edge-test-url.sh`
  - L2: `# Shared helpers: edge-only E2E / k6 (https://off-campus-housing.test), no port-forward / :4020.`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/webapp-playwright-strict-edge.sh`
  - L7: `#   E2E_API_BASE   — https only (default https://off-campus-housing.test); :4020 / http localhost rejected`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/api-gateway/Dockerfile`
  - L62: `EXPOSE 4020`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/api-gateway/README.md`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/api-gateway/src/server.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/services/transport-watchdog/src/index.ts`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/webapp/next.config.mjs`
...
**Hits:** 238 (capped per file in scanner)

- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/GOLDEN_SNAPSHOT_AND_CHAOS.md`
  - L23: `export HOUSING_NS=record-platform`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/Makefile`
  ...
  - … *3 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/README-BUNDLE.md`
  - L9: `Override anytime: **`export HOUSING_NS=record-platform`** (already the default here) or your own namespace.`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/infra/k8s/kafka-certs/README.md`
  - L24: `HOUSING_NS=record-platform bash scripts/verify-kafka-tls-sans.sh`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/apply-kafka-kraft-staged.sh`
  - L11: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/auth-outbox-replay.sh`
  - L11: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/bring-up-external-infra.sh`
  - L38: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/chaos-kafka-alignment-stochastic.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/chaos-kafka-broker.sh`
  - L16: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/chaos-metallb-kafka-lb.sh`
  - L13: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/check-all-pods-and-tls.sh`
  - L81: `_KNS="${HOUSING_NS:-record-platform}"`
  - L125: `HOUSING_CHECK_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/check-kafka-config-drift.sh`
  - L12: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/canary-pod-stability.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/hydrate-certs-for-ci.sh`
  - L14: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/k6-smoke-incluster.sh`
  - L6: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/post-deploy-verify.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/smoke-api-gateway.sh`
  ...
  - L6: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ci/verify-k8s-images.sh`
  - L18: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/cleanup-kafka-ops-cronjob-pods.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-ready-for-preflight.sh`
  - L131: `_KNS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/ensure-strict-tls-mtls-preflight.sh`
  - L14: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/export-kafka-ca-metric.sh`
  - L9: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/golden-snapshot-verify.sh`
  - L19: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k8s-diagnose-restarts.sh`
  - L10: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/k8s-rollout-och-ordered.sh`
  - L4: `#   HOUSING_NS=record-platform  (default)`
  - L12: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-after-rollout-verify-brokers.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-auto-heal-inter-broker-tls.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-clean-slate.sh`
  - L9: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-onboarding-reset.sh`
  - L8: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-quorum-stable.sh`
  - L13: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-refresh-tls-from-lb.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-runtime-sync.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/kafka-sync-metallb.sh`
  - L12: `NS="${HOUSING_NS:-record-platform}"`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/lib/protocol-verification.sh`
  - L342: `# SNI validation: QUIC with off-campus-housing.test = definitive proof traffic belongs to our domain (no background noise).`
  - L349: `[[ "$sni_total" -gt 0 ]] && echo "  OK: $label QUIC SNI off-campus-housing.test: $sni_total packets (definitive proof traffic to our domain)"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/k6-edge-load-diagnostics.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/run-k6-all-services.sh`
  - L8: `#   BASE_URL              default https://off-campus-housing.test:443 or :30443`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/run-k6-listings-concurrency-instrumented.sh`
  - L15: `export HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/load/run-k6-phases.sh`
  - L35: `echo "  ❌ Do not use raw IP for strict TLS. Use hostname (e.g. https://off-campus-housing.test:443) and K6_RESOLVE."`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/probe-kafka-kraft-listeners.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rebuild-housing-colima.sh`
  - L30: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rebuild-och-images-and-rollout.sh`
  - L34: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-deferred-after-kafka-tls.sh`
  - L16: `export OCH_ROLLOUT_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/rollout-restart-och-full-stack.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-k6-chaos.sh`
  - L303: `K6_TARGET="${K6_TARGET_URL:-https://off-campus-housing.test:30443/_caddy/healthz}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-preflight-scale-and-all-suites.sh`
  - L427: `local _ns="${HOUSING_NS:-record-platform}"`
  - L435: `VERIFY_K8S_SERVICES="$PREFLIGHT_APP_DEPLOYS" HOUSING_NS="$_ns" \`
  - L509: `HOUSING_NS="${HOUSING_NS:-record-platform}" \`
  - L1438: `if HOUSING_NS="${HOUSING_NS:-record-platform}" FORCE_TLS_RESTART=0 "$SCRIPT_DIR/ensure-housing-cluster-secrets.sh"; then`
  - L1707: `_housing_ns="${HOUSING_NS:-record-platform}"`
  - L1869: `_kraft_ns="${HOUSING_NS:-record-platform}"`
  - L2610: `"https://off-campus-housing.test:30443/_caddy/healthz" 2>/dev/null) || true`
  - L2613: `ok "HTTP/3 (NodePort 30443) OK — QUIC reachable from host via off-campus-housing.test:30443"`
  - L2711: `_k8s_ns="${HOUSING_NS:-record-platform}"`
  - L2737: `_k8s_ns_b="${HOUSING_NS:-record-platform}"`
  - L2771: `_sk_ns="${HOUSING_NS:-record-platform}"`
  ...
  - … *7 more in this file*
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/run-suite-with-packet-capture.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/tests/kafka-alignment-suite.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-caddy-http3-in-cluster.sh`
  ...
  - L74: `CURL_RESOLVE="off-campus-housing.test:443:${TARGET_IP}"`
  - L78: `CURL_RESOLVE="off-campus-housing.test:443:${_cluster_ip}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-cluster-kafka-three-brokers.sh`
  - L4: `#   HOUSING_NS=record-platform (default)`
  - L7: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-housing-kafka-bootstrap.sh`
  - L7: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-cluster.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-kraft-advertised-listeners.sh`
  - L15: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-kafka-no-static-advertised-env.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/verify-required-housing-pods.sh`
...
- `record-platform-final-vitest-kafka-event-layer-chaos-golden-20260410/scripts/wait-for-kafka-external-lb-ips.sh`
  - L6: `NS="${HOUSING_NS:-record-platform}"`
