# OCH → RP rewrite scan: `record-platform-kafka-ops-certs-alignment-cron-preflight-20260410`

**Staging (read-only scan):** `/Users/tom/bundle-staging/record-platform-kafka-ops-certs-alignment-cron-preflight-20260410`
...
**Hits:** 46 (capped per file in scanner)

- `record-platform-kafka-ops-certs-alignment-cron-20260410/README-BUNDLE.md`
  - L64: `Follow **Off-Campus-Housing-Tracker** upstream license.`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/build-and-load-auth-service.sh`
  - L44: `say "Done. Deploy with: kubectl apply -k infra/k8s/base/auth-service (ensure namespace off-campus-housing exists)."`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/check-all-pods-and-tls.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/generate-kafka-ci-tls.sh`
  - L28: `-subj "/CN=och-kafka-ci-ca/O=off-campus-housing-ci" \`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/deploy-dev.sh`
  - L40: `LEAF_TLS_SECRET="${LEAF_TLS_SECRET:-off-campus-housing-local-tls}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/dev-generate-certs.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-caddy-envoy-strict-tls.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/load-caddy-image-colima.sh`
  - L3: `# Strict TLS/mTLS: Caddy uses off-campus-housing-local-tls + dev-root-ca in ingress-nginx (from strict-tls-bootstrap).`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/reissue-ca-and-leaf-load-all-services.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-caddy.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rotation-suite.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-preflight-scale-and-all-suites.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run_auth_pgbench_sweep.sh`
  - L21: `-n, --namespace NS       Kubernetes namespace (default: off-campus-housing)`
  - L57: `NS="off-campus-housing"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run_pgbench_sweep.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/setup-full-off-campus-housing-stack.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/setup-new-colima-cluster.sh`
  - L138: `say "One-shot (idiot-proof): ./scripts/setup-full-off-campus-housing-stack.sh — see docs/RUN_PIPELINE_ORDER.md"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/strict-tls-bootstrap.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-full-chain-with-rotation.sh`
  - L45: `LEAF_TLS_SECRET="${LEAF_TLS_SECRET:-off-campus-housing-local-tls}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-tls-mtls-comprehensive.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-http3-edge.sh`
...
**Hits:** 453 (capped per file in scanner)

- `record-platform-kafka-ops-certs-alignment-cron-20260410/README-BUNDLE.md`
  - L46: `3. TLS material: **`record-platform-tls-three-stage-verify.sh`** → sync **`och-kafka-ssl-secret`** (see OCH scripts).`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/RECORD_PLATFORM_PREFLIGHT_KAFKA_OPS_SETUP.md`
  - L32: `Apply the generated **`och-kafka-ssl-secret`** (or let **`kafka-ssl-from-dev-root.sh`** / **`reissue`** push it — follow script output). Confirm:`
  - L61: `# If DNS missing: export OCH_EDGE_IP=<LB IP> and use scripts/lib/edge-test-url.sh hints or OCH_AUTO_EDGE_HOSTS=1`
  - L89: `Brokers still expect **JKS** in **`och-kafka-ssl-secret`** today — use init containers or keep **`kafka-ssl-from-dev-root.sh`** until PEM/JKS wiring per pod is implemented (**`infra/k8s/kafka-certs…`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/infra/k8s/kafka-certs/README.md`
  - L47: `After Kafka and `och-kafka-ssl-secret` exist:`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/infra/k8s/kafka-certs/kafka-tls-preflight-job.yaml`
  - L2: `# Apply after Kafka + och-kafka-ssl-secret exist:`
  - L52: `secretName: och-kafka-ssl-secret`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/infra/ops/README.md`
  - L52: `SERVICES="auth-service trust-service" ./scripts/rebuild-och-images-and-rollout.sh`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/infra/slo/error-budget-policy.md`
  - L12: `## Burn detection (aligned with `infra/k8s/base/observability/prometheus-rules-och-slo.yaml`)`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/aggressive-cleanup-replicasets.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/apply-och-messaging-and-restart.sh`
  - L3: `# Prereq: OCH secrets exist (och-service-tls, och-kafka-ssl-secret).`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/assert-kafka-integration-cluster.mjs`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/bring-up-external-infra.sh`
  - L10: `#   ./scripts/recycle-och-postgres-compose.sh`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/build-housing-images-k3s.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/delete-kafka-event-topics.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/start-kafka-tls-ci.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/verify-housing-grpc-matrix.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/colima-edge-sysctl-tuning.sh`
  - L6: `# Persist: create /etc/sysctl.d/99-och-edge.conf with the same keys (distribution-specific).`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/colima-patch-app-config-db-host-to-gateway.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/create-kafka-event-topics-k8s.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/create-kafka-event-topics.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/dev-onboard-local.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/dev-onboard-zero-trust-preflight.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/diagnose-k6-edge-connectivity.sh`
  - L81: `echo "  # If DNS missing: add \"$LB_IP $HOST\" to /etc/hosts or: OCH_AUTO_EDGE_HOSTS=1 with sudo"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/diagnose-och-deployment.sh`
  - L3: `# Usage: ./scripts/diagnose-och-deployment.sh media-service`
  - L4: `#        ./scripts/diagnose-och-deployment.sh auth-service`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-all-services-tls.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-edge-hosts.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-housing-cluster-secrets.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-strict-tls-mtls-preflight.sh`
  ...
  - … *2 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/install-metallb-colima.sh`
  - L124: `if ! och_assert_metallb_pool_coherent "$METALLB_POOL"; then`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/k8s-rollout-och-ordered.sh`
  - L3: `# Usage: ./scripts/k8s-rollout-och-ordered.sh`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-refresh-tls-from-lb.sh`
  - L2: `# Regenerate kafka-ssl-secret (and och-kafka-ssl-secret) with SANs that include current`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-rolling-restart.sh`
  - L36: `if ! och_kafka_kraft_quorum_ok "$NS"; then`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-ssl-from-dev-root.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-tls-guard.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-tls-rotate-atomic.sh`
  - L30: `echo "▶ Regenerate kafka-ssl-secret + och-kafka-ssl-secret (full JKS + PEM)"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/edge-test-url.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/ensure-colima-docker-context.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/ensure-och-grpc-certs.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/grpc-http3-health.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/grpc-utils.sh`
  - L7: `och_housing_ns() {`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/kafka-broker-sans.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/kafka-kraft-quorum-ok.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/metallb-subnet-guard.sh`
  ...
  - … *1 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/och-housing-docker-services-default.sh`
  - L2: `# transport-watchdog: image only; rollouts map to deploy/api-gateway (see rebuild-och-images-and-rollout.sh).`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/och-kafka-event-topics-from-proto.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/lib/och-sequential-rollout.sh`
  - L8: `#     och_kubectl() { kctl "$@"; }`
  ...
  - … *1 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/patch-kafka-external-host.sh`
  - L44: `RAW=$(kubectl run och-resolve-kafka-host --rm -i --restart=Never --image=busybox:1.36 -n record-platform -- \`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/perf/build-canonical-bundle.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/preflight-kafka-k8s-rollout.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/protocol/test-service-protocol.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rebuild-all-housing-images-k3s.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rebuild-och-images-and-rollout.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rebuild-traffic-control-stack.sh`
  - L11: `exec "$ROOT/scripts/rebuild-och-images-and-rollout.sh"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/record-platform-tls-three-stage-verify.sh`
  - L2: `# Three-stage TLS for Record Platform / OCH-style clusters:`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/recycle-och-postgres-compose.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/restore-external-postgres-from-backup.sh`
  - L44: `och_terminate_db_sessions() {`
  - L58: `och_terminate_db_sessions "$port" "$db"`
  - L66: `och_terminate_db_sessions "$port" "$db"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-deferred-after-kafka-tls.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-restart-och-after-pool-tuning.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-restart-och-full-stack.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-all-test-suites.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-housing-k6-edge-smoke.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/service-tls-alias-guard.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/slo/check-error-budget.js`
  - L11: `*   OCH_SLO_TARGET      — decimal availability target (default: 0.995)`
  - L21: `const SLO_TARGET = Number(process.env.OCH_SLO_TARGET || "0.995");`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-booking-http2-http3.sh`
  - L24: `for _sec in och-service-tls service-tls; do`
  - L115: `for _sec in och-service-tls service-tls; do`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-microservices-http2-http3-housing.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-packet-capture-standalone.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/tls-k8s-secrets-expiry.sh`
  - L17: `echo "och_tls_cert_days_remaining{namespace=\"$ns\",secret=\"$sec\"} $days"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/transport/http3-concurrent-curl-stress.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/validate-kafka-stack-contract.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-caddy-grpc-routing.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-deletion-flow.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-cluster.sh`
  ...
  - … *1 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-event-topic-partitions.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-kraft-e2e.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-tls-sans.sh`
  - L104: `done < <(och_kafka_emit_san_verify_dns_specs "$NS" "$REPLICAS")`
  - L120: `done < <(och_kafka_metallb_external_lb_ips_lines "$NS" "$REPLICAS")`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-network-coherence.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-preflight-edge-routing.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-proto-events-topics.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-proto-topic-alignment.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/wait-for-all-services-ready.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/wait-for-docker-compose-kafka-strict-ready.sh`
  - L6: `#   REPO_ROOT, ENV_PREFIX (default dev), OCH_KAFKA_TOPIC_SUFFIX (optional)`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/smoke-api-gateway.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/edge-readiness-gate.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/k6/k6-smoke-gateway.js`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-playwright-e2e-preflight.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-lb-coordinated.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/webapp-playwright-strict-edge.sh`
...
**Hits:** 174 (capped per file in scanner)

- `record-platform-kafka-ops-certs-alignment-cron-20260410/RECORD_PLATFORM_PREFLIGHT_KAFKA_OPS_SETUP.md`
  - L27: `export HOUSING_NS=record-platform`
  - L36: `HOUSING_NS=record-platform ./scripts/verify-kafka-tls-sans.sh`
  - L37: `HOUSING_NS=record-platform ./scripts/validate-kafka-dns.sh`
  - L43: `HOUSING_NS=record-platform ./scripts/create-kafka-event-topics-k8s.sh`
  - L67: `export HOUSING_NS=record-platform`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/infra/k8s/kafka-certs/README.md`
  - L24: `HOUSING_NS=record-platform bash scripts/verify-kafka-tls-sans.sh`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/apply-kafka-kraft-staged.sh`
  - L11: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/auth-outbox-replay.sh`
  - L11: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/bring-up-external-infra.sh`
  - L38: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/chaos-kafka-alignment-stochastic.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/chaos-kafka-broker.sh`
  - L16: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/chaos-metallb-kafka-lb.sh`
  - L13: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/check-all-pods-and-tls.sh`
  - L81: `_KNS="${HOUSING_NS:-record-platform}"`
  - L125: `HOUSING_CHECK_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/check-kafka-config-drift.sh`
  - L12: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/canary-pod-stability.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/hydrate-certs-for-ci.sh`
  - L14: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/k6-smoke-incluster.sh`
  - L6: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/post-deploy-verify.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/smoke-api-gateway.sh`
  ...
  - L6: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ci/verify-k8s-images.sh`
  - L18: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/cleanup-kafka-ops-cronjob-pods.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-ready-for-preflight.sh`
  - L131: `_KNS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/ensure-strict-tls-mtls-preflight.sh`
  - L14: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/export-kafka-ca-metric.sh`
  - L9: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/golden-snapshot-verify.sh`
  - L19: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/k8s-diagnose-restarts.sh`
  - L10: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/k8s-rollout-och-ordered.sh`
  - L4: `#   HOUSING_NS=record-platform  (default)`
  - L12: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-after-rollout-verify-brokers.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-auto-heal-inter-broker-tls.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-clean-slate.sh`
  - L9: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-onboarding-reset.sh`
  - L8: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-quorum-stable.sh`
  - L13: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-refresh-tls-from-lb.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-runtime-sync.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/kafka-sync-metallb.sh`
  - L12: `NS="${HOUSING_NS:-record-platform}"`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/load/k6-edge-load-diagnostics.sh`
  - L16: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
  - L45: `echo "=== $tag @ $(date -u +%Y-%m-%dT%H:%M:%SZ) ns=$HOUSING_NS ==="`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/load/run-k6-listings-concurrency-instrumented.sh`
  - L15: `export HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/probe-kafka-kraft-listeners.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rebuild-housing-colima.sh`
  - L30: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rebuild-och-images-and-rollout.sh`
  - L34: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/record-platform-tls-three-stage-verify.sh`
  - L14: `#   HOUSING_NS=record-platform KAFKA_SSL_EXTRA_IP_SANS=1.2.3.4,5.6.7.8 ./scripts/record-platform-tls-three-stage-verify.sh`
  - L21: `export HOUSING_NS="${HOUSING_NS:-record-platform}"`
  - L27: `say "=== record-platform-tls-three-stage-verify (HOUSING_NS=$HOUSING_NS) ==="`
  - L52: `HOUSING_NS="$HOUSING_NS" bash "$SCRIPT_DIR/reissue-ca-and-leaf-load-all-services.sh" || {`
  - L53: `warn "reissue-ca-and-leaf-load-all-services.sh failed — run manually: HOUSING_NS=$HOUSING_NS pnpm run reissue"`
  - L57: `warn "No kubectl or namespace $HOUSING_NS — skip Stage 3. When cluster exists: HOUSING_NS=$HOUSING_NS pnpm run reissue"`
  - L68: `HOUSING_NS="$HOUSING_NS" KAFKA_BROKER_REPLICAS="${KAFKA_BROKER_REPLICAS:-3}" bash "$SCRIPT_DIR/kafka-after-rollout-verify-brokers.sh"`
  - L71: `warn "Skip broker parity (no kafka-0 in $HOUSING_NS yet). After rollout: HOUSING_NS=$HOUSING_NS ./scripts/kafka-after-rollout-verify-brokers.sh"`
  - L78: `echo "  HOUSING_NS=$HOUSING_NS bash scripts/verify-kafka-tls-sans.sh"`
  - L79: `echo "  HOUSING_NS=$HOUSING_NS bash scripts/validate-kafka-dns.sh"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-deferred-after-kafka-tls.sh`
  - L16: `export OCH_ROLLOUT_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/rollout-restart-och-full-stack.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-all-test-suites.sh`
  - L192: `och_sync_grpc_certs_to_dir "${GRPC_CERTS_DIR:-/tmp/grpc-certs}" "${HOUSING_NS:-record-platform}" || true`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-demo-network-preflight.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - … *5 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/run-suite-with-packet-capture.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-messaging-service-comprehensive.sh`
  - L18: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/test-microservices-http2-http3-enhanced.sh`
  - L19: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/tests/kafka-alignment-suite.sh`
  ...
  - … *4 more in this file*
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-cluster-kafka-three-brokers.sh`
  - L4: `#   HOUSING_NS=record-platform (default)`
  - L7: `HOUSING_NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-housing-kafka-bootstrap.sh`
  - L7: `NS="${HOUSING_NS:-record-platform}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-cluster.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-kraft-advertised-listeners.sh`
  - L15: `NS="${1:-${HOUSING_NS:-record-platform}}"`
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-kafka-no-static-advertised-env.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/verify-required-housing-pods.sh`
...
- `record-platform-kafka-ops-certs-alignment-cron-20260410/scripts/wait-for-kafka-external-lb-ips.sh`
  - L6: `NS="${HOUSING_NS:-record-platform}"`
