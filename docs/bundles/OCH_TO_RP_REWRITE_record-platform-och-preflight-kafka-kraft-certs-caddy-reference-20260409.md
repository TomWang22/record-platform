# OCH → RP rewrite scan: `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409`

**Staging (read-only scan):** `/Users/tom/bundle-staging/record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409`
...
**Hits:** 996 (capped per file in scanner)

- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/CADDY_IMAGE_XCADDY_TCPDUMP_TSHARK.md`
  - L57: `Manifests live under **`infra/k8s/caddy-h3-*.yaml`** (included). Ensure TLS Secrets exist in the expected namespace (**`off-campus-housing-local-tls`**, **`dev-root-ca`**, etc.) per **`strict-tls-b…`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/Caddyfile`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/Makefile`
  ...
  - … *3 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/PLATFORM_REUSE_AND_PREFLIGHT.md`
  - L105: `- Align **namespace** (`off-campus-housing-tracker` → your namespace) in manifests and exports.`
  - L106: `- Re-point **hostnames** (`off-campus-housing.test`) in edge scripts and **`Caddyfile`** / ConfigMaps.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/README-BUNDLE.md`
  - L27: ``HOUSING_NS=off-campus-housing-tracker ./scripts/tests/kafka-alignment-suite.sh``
  - L44: `Follow **Off-Campus-Housing-Tracker** upstream license.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/certs/README.txt`
  - L18: `Expected artifacts (local only): `dev-root.pem`, `dev-root.key`, `off-campus-housing.test.{crt,key}`,`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/docker/caddy-with-tcpdump/Dockerfile`
  - L5: `# k3d: k3d image import caddy-with-tcpdump:dev -c off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/docker/caddy-with-tcpdump/README.md`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/README.md`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/analytics-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/analytics-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/api-gateway/deploy.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/api-gateway/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/auth-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/auth-service/grpc-health-probe.yaml`
  - L8: `namespace: off-campus-housing-tracker`
  - L15: `HOST="${2:-auth-service.off-campus-housing-tracker.svc.cluster.local:50061}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/auth-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/booking-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/booking-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/app-config.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/app-secrets.yaml`
  - L42: `SMTP_FROM: "noreply@off-campus-housing-tracker.local"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/kustomization.yaml`
  - L3: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/analytics.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/analytics";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/booking.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/booking";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/common.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/common";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/events/auth.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events/auth";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/events/envelope.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/events";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/events/messaging/v1/messaging_events.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing/proto/events/messaging/v1";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/listings.proto`
  - L7: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/listings";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/media.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/media";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/messaging.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing/proto/messaging/v1";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/notification.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/notification";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/config/proto/trust.proto`
  - L5: `option go_package = "github.com/yourorg/off-campus-housing-tracker/proto/trust";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/envoy-test/deploy.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/envoy-test/envoy.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/exporters/haproxy-exporter.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L27: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/exporters/nginx-exporter.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L53: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/haproxy/configmap.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/haproxy/deploy.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/haproxy/haproxy.cfg`
  - L37: `server api api-gateway.off-campus-housing-tracker.svc.cluster.local:4020 check init-addr none resolvers k8s`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/haproxy/kustomization.yaml`
  - L3: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/haproxy/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka-ca-exporter/configmap.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L19: `NS = os.environ.get("HOUSING_NS", "off-campus-housing-tracker")`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka-ca-exporter/deployment.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L34: `value: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka-ca-exporter/rbac.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L13: `namespace: off-campus-housing-tracker`
  - L24: `namespace: off-campus-housing-tracker`
  - L32: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka-ca-exporter/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka-external/external-service.yaml`
  - L12: `namespace: off-campus-housing-tracker`
  - L25: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka/external-service.yaml`
  - L7: `namespace: off-campus-housing-tracker`
  - L20: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kafka/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/kustomization.yaml`
  - L2: `# Replace off-campus-housing-tracker namespace with your app namespace in all manifests.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/listings-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/listings-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/media-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/media-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/messaging-service/deploy.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/messaging-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/monitoring/servicemonitors.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L8: `matchNames: ["off-campus-housing-tracker"]`
  - L32: `namespace: off-campus-housing-tracker`
  - L35: `matchNames: ["off-campus-housing-tracker"]`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/namespaces.yaml`
  - L4: `name: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/nginx/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/nginx/kustomization.yaml`
  - L3: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/nginx/nginx.conf`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/nginx/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/notification-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/notification-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/grafana-deploy.yaml`
  - L44: `value: https://off-campus-housing.test/grafana/`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/podmonitors.yaml`
  - L4: `name: off-campus-housing-tracker-services`
  - L7: `app: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/prometheus-deploy.yaml`
  - L26: `- off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/prometheus-rules-kafka-health.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/redis/external-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L19: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/redis/kustomization.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/trust-service/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/trust-service/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/webapp/deploy.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/webapp/service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/caddy-h3-configmap.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/caddy-h3-deploy-loadbalancer.yaml`
  - L88: `secretName: off-campus-housing-local-tls`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/caddy-h3-deploy.yaml`
  - L98: `secretName: off-campus-housing-local-tls`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/caddy-h3-service-clusterip.yaml`
  - L3: `# Apply this instead of caddy-h3-service.yaml when using scripts/k3d-create-off-campus-housing-tracker-443-lb.sh.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/echo-backend.yaml`
  - L5: `name: off-campus-housing-tracker`
  - L11: `namespace: off-campus-housing-tracker`
  - L30: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/ingress-nginx-envoy.yaml`
  ...
  - … *5 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/README.md`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/certificates/kafka-0-cert.yaml`
  - L6: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/certificates/kafka-1-cert.yaml`
  - L6: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/certificates/kafka-2-cert.yaml`
  - L6: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/kafka-tls-preflight-job.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/external-services.yaml`
  - L8: `namespace: off-campus-housing-tracker`
  - L23: `namespace: off-campus-housing-tracker`
  - L38: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/headless-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/kafka-metallb-alignment-exporter.yaml`
  - L7: `namespace: off-campus-housing-tracker`
  - L13: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/kafka-pdb.yaml`
  - L7: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/kustomization.yaml`
  - L5: `#   - Namespace off-campus-housing-tracker`
  - L33: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/rbac-kafka-svc-reader.yaml`
  - L7: `namespace: off-campus-housing-tracker`
  - L14: `namespace: off-campus-housing-tracker`
  - L26: `namespace: off-campus-housing-tracker`
  - L35: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-kraft-metallb/statefulset.yaml`
  - L12: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-ops/kafka-alignment-cronjob.yaml`
  - L13: `namespace: off-campus-housing-tracker`
  - L19: `namespace: off-campus-housing-tracker`
  - L32: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/bgpadvertisement.example.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/bgpadvertisement.yaml`
  - L1: `# BGPAdvertisement: advertise off-campus-housing-tracker-pool to BGP peer (FRR).`
  - L5: `name: off-campus-housing-tracker-pool`
  - L9: `- off-campus-housing-tracker-pool`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/bgppeer-frr.yaml`
  - L5: `name: off-campus-housing-tracker-frr`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/bgppeer.example.yaml`
  - L7: `name: off-campus-housing-tracker-frr`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/bgppeer.yaml`
  - L5: `name: off-campus-housing-tracker-frr`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/ipaddresspool.yaml`
  - L6: `name: off-campus-housing-tracker-pool`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/metallb/l2advertisement.yaml`
  ...
  - L9: `- off-campus-housing-tracker-pool`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/monitoring/kafka-election-exporter-stub.yaml`
  - L11: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/observability/chaos-nightly-cronjob.yaml`
  - L8: `#   namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/bootstrap.sh`
  - L4: `CLUSTER=off-campus-housing-tracker`
  - L5: `NAMESPACE=off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/cronjobs/pg-backup-pvc.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L24: `- { name: PGHOST,     value: postgres.off-campus-housing-tracker.svc.cluster.local }`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/hpa-api-gateway.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/ingress-grpc.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/ingress-privacy-terms.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/ingress.yaml`
  - L4: `name: off-campus-housing-tracker`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/bootstrap-from-basebackup.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/bootstrap-rbac.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L11: `namespace: off-campus-housing-tracker`
  - L24: `namespace: off-campus-housing-tracker`
  - L32: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/postgres-postinit-bundle.yaml`
  - L6: `namespace: off-campus-housing-tracker`
  ...
  - … *1 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/postgres-postinit-debug.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/postgres-postinit-job-template.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/postgres-postinit-sql-cm.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/postgres-restore-from-pvc.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L18: `- { name: PGHOST,     value: postgres.off-campus-housing-tracker.svc.cluster.local }`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/restore-from-dump.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/seed-auth.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L35: `wget -qO- https://github.com/TomWang22/off-campus-housing-tracker/archive/refs/heads/main.tar.gz \`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/seed-records.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L35: `wget -qO- https://github.com/TomWang22/off-campus-housing-tracker/archive/refs/heads/main.tar.gz \`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/analytics-analytics-sync-env.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/api-gateway-resources.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- … *228 more paths*
...
**Hits:** 319 (capped per file in scanner)
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/jobs/seed-records.yaml`
  - L35: `wget -qO- https://github.com/TomWang22/off-campus-housing-tracker/archive/refs/heads/main.tar.gz \`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/listings-analytics-sync-env.yaml`
  - L16: `value: "http://analytics-service.off-campus-housing-tracker.svc.cluster.local:4017"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/apply-metallb-pool-colima.sh`
  - L48: `echo "Then: curl -k --http3 https://$ext_ip/_caddy/healthz  (or add $ext_ip off-campus-housing.test to /etc/hosts)"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/build-k6-http3.sh`
  - L92: `say "  $INSTALL_DIR/k6-http3 run -e BASE_URL=https://off-campus-housing.test scripts/load/k6-http3-complete.js"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/verify-quic-hostname-invariant.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/compare-h2-h3-headers.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/dev-generate-certs.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/diagnose-k6-edge-connectivity.sh`
  - L14: `HOST="${EDGE_HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/enhanced-adversarial-tests.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-caddy-envoy-strict-tls.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-colima-metallb-for-l2.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-edge-hosts.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-strict-tls-mtls-preflight.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/generate-envoy-client-cert.sh`
  - L3: `# Backends expect a client identity; the edge leaf (off-campus-housing.test) is not a service identity.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/k6-chaos-test.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/k6-exec-strict-edge.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/k6/k6-smoke-gateway.js`
  - L15: `"http://api-gateway.off-campus-housing-tracker.svc.cluster.local:4020";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/COHERENT_ANALYSIS.md`
  - L29: `1. Prove **TLS + SNI** (`off-campus-housing.test`) and **HTTP/2** to Caddy.`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/edge-test-url.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/ensure-och-grpc-certs.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/grpc-http3-health.sh`
  - L14: `local host="${HOST:-off-campus-housing.test}"`
  - L73: `local grpc_authority="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/http3.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/packet-capture-v2.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/packet-capture.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/protocol-verification.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/trust-dev-root-ca-macos.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-analytics-daily-smoke.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-analytics-listing-feel-smoke.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-find-max-rps-http3.js`
  - L17: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L18: `const BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-http3-complete.js`
  - L60: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L62: `const BASE_URL = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-http3-toolchain.js`
  - L58: `const BASE_URL = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
  - L60: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-limit-test-comprehensive.js`
  - L38: `const HOST = __ENV.HOST || 'off-campus-housing.test';`
  - L39: `const BASE_URL = __ENV.BASE_URL || 'https://off-campus-housing.test';`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-listings-health.js`
  - L20: `: "https://off-campus-housing.test";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-listings.js`
  - L9: `const rawBase = (__ENV.BASE_URL || "https://off-campus-housing.test").replace(/\/$/, "");`
  - L22: `const host = __ENV.HOST || "off-campus-housing.test";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-media-upload.js`
  - L13: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-messaging-direct-message.js`
  - L6: `*   BASE_URL          — https://off-campus-housing.test (default)`
  - L25: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-messaging-e2e.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-messaging-flow.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-messaging-limit-finder.js`
  - L12: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-messaging.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-reads.js`
  - L7: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-spam-test.js`
  - L15: `const RAW_BASE = (__ENV.BASE_URL || 'https://off-campus-housing.test').replace(/\/$/, '');`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-strict-edge-tls.js`
  - L9: `* https://off-campus-housing.test so `k6 run scripts/load/k6-*.js` works from repo root.`
  - L15: `: "https://off-campus-housing.test";`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/run-k6-all-services.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/run-k6-phases.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/perf/run-all-k6-load-report.sh`
  - L10: `#   BASE_URL              default https://off-campus-housing.test`
  - L25: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/perf/run-k6-cross-service-isolation.sh`
  - L36: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/perf/run-preflight-phase-d-tail-lab.sh`
  - L60: `export BASE_URL="${BASE_URL:-https://off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/protocol/full-edge-transport-validation.sh`
  - L23: `export HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/protocol/test-service-protocol.sh`
  - L26: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/reissue-ca-and-leaf-load-all-services.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rollout-caddy.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rotation-suite.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-all-test-suites.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-demo-network-preflight.sh`
  - L42: `export HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-housing-k6-edge-smoke.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-k6-chaos.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-playwright-e2e-preflight.sh`
  - L10: `#   E2E_API_BASE           — must be https (default https://off-campus-housing.test)`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - … *3 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-transport-study-experiments.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/setup-full-off-campus-housing-stack.sh`
  - L45: `LEAF="$REPO_ROOT/certs/off-campus-housing.test.crt"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/setup-lb-ip-host-access.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/setup-tls-and-edge.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/smoke-services.sh`
  - L7: `HOST="${HOST:-off-campus-housing.test}"`
  - L45: `# Ensure host resolves (optional: add off-campus-housing.test to /etc/hosts if needed)`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/smoke-test-dev.sh`
  - L4: `#   BASE_URL=https://off-campus-housing.test  (default from PORT/LB)`
  - L11: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/strict-tls-bootstrap.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-auth-service.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-booking-http2-http3.sh`
  - L11: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-full-chain-with-rotation.sh`
  - L5: `HOST="${HOST:-off-campus-housing.test}"`
  - L454: `ROTATION_HOST="$HOST"  # off-campus-housing.test`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-grpc-http2-http3.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-http2-http3-strict-tls.sh`
  - L6: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-lb-coordinated.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-listings-http2-http3.sh`
  - L17: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-messaging-service-comprehensive.sh`
  - L20: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-microservices-http2-http3-enhanced.sh`
  - L21: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-microservices-http2-http3-housing.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-packet-capture-standalone.sh`
  - L25: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/test-tls-mtls-comprehensive.sh`
  - L19: `HOST="${HOST:-off-campus-housing.test}"`
  - L142: `grpc_authority="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/transport/http3-concurrent-curl-stress.sh`
  - L5: `#   OCH_H3_URL=https://off-campus-housing.test/api/healthz \`
  - L14: `URL="${OCH_H3_URL:-https://off-campus-housing.test/api/healthz}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-caddy-grpc-routing.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-caddy-http3-in-cluster.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-caddy-strict-tls-in-cluster.sh`
  - L8: `#   2. Creates a temporary Pod with curl image and CA mounted; runs curl with --cacert and Host: off-campus-housing.test.`
  - L22: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-caddy-strict-tls.sh`
  - L18: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-db-and-cache-comprehensive.sh`
  - L112: `HOST="${HOST:-off-campus-housing.test}"`
  - L158: `HOST="${HOST:-off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-http3-edge.sh`
  - L6: `#   TARGET=https://off-campus-housing.test  (default)`
  - L29: `TARGET="${TARGET:-https://off-campus-housing.test}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-metallb-and-traffic-policy.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-preflight-edge-routing.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/webapp-playwright-strict-edge.sh`
...
**Hits:** 520 (capped per file in scanner)
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/PLATFORM_REUSE_AND_PREFLIGHT.md`
  - L32: `3. **Kafka broker JKS / PEM for `och-kafka-ssl-secret`:**`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/analytics-service/deploy.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/notification-service/deploy.yaml`
  - L139: `secretName: och-service-tls`
  - L149: `secretName: och-kafka-ssl-secret`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/alertmanager-slo-route-example.yaml`
  - L12: `name: alertmanager-och-slo-example`
  - L34: `channel: "#och-slo-warning"`
  - L42: `channel: "#och-slo-critical"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/grafana-dashboard-auth-outbox.yaml`
  - L13: `"uid": "och-auth-outbox",`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/grafana-dashboard-providers.yaml`
  - L11: `- name: och-file`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/grafana-dashboards-transport.yaml`
  - L10: `och-transport-edge.json: |`
  - L108: `"uid": "och-transport-edge",`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/grafana-dashboards.yaml`
  - L107: `"uid": "och-microservices-overview",`
  - L176: `"uid": "och-distributed-tracing",`
  - L269: `"uid": "och-housing-uptime",`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/kustomization.yaml`
  - L10: `- prometheus-rules-och-slo.yaml`
  - L27: `#   och-slo-prometheusrule.yaml     — Prometheus Operator PrometheusRule`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/och-slo-prometheusrule.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/base/observability/prometheus-rules-och-slo.yaml`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/package.json`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/aggressive-cleanup-replicasets.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/apply-och-messaging-and-restart.sh`
  - L3: `# Prereq: OCH secrets exist (och-service-tls, och-kafka-ssl-secret).`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/assert-kafka-integration-cluster.mjs`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/bring-up-external-infra.sh`
  - L10: `#   ./scripts/recycle-och-postgres-compose.sh`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/build-housing-images-k3s.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/check-all-pods-and-tls.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/delete-kafka-event-topics.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/generate-kafka-ci-tls.sh`
  - L28: `-subj "/CN=och-kafka-ci-ca/O=off-campus-housing-ci" \`
  - L36: `-subj "/CN=${CN}/O=och-kafka-ci"`
  - L59: `-subj "/CN=kafka-client/O=och-kafka-ci"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/start-kafka-tls-ci.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/verify-housing-grpc-matrix.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/colima-edge-sysctl-tuning.sh`
  - L6: `# Persist: create /etc/sysctl.d/99-och-edge.conf with the same keys (distribution-specific).`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/colima-patch-app-config-db-host-to-gateway.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/create-kafka-event-topics-k8s.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/create-kafka-event-topics.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/dev-onboard-local.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/dev-onboard-zero-trust-preflight.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/diagnose-och-deployment.sh`
  - L3: `# Usage: ./scripts/diagnose-och-deployment.sh media-service`
  - L4: `#        ./scripts/diagnose-och-deployment.sh auth-service`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-all-services-tls.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-housing-cluster-secrets.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-strict-tls-mtls-preflight.sh`
  ...
  - … *2 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/install-metallb-colima.sh`
  - L124: `if ! och_assert_metallb_pool_coherent "$METALLB_POOL"; then`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/k8s-rollout-och-ordered.sh`
  - L3: `# Usage: ./scripts/k8s-rollout-och-ordered.sh`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-refresh-tls-from-lb.sh`
  - L2: `# Regenerate kafka-ssl-secret (and och-kafka-ssl-secret) with SANs that include current`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-rolling-restart.sh`
  - L36: `if ! och_kafka_kraft_quorum_ok "$NS"; then`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-ssl-from-dev-root.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-tls-guard.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-tls-rotate-atomic.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/ensure-colima-docker-context.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/grpc-utils.sh`
  - L7: `och_housing_ns() {`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/kafka-broker-sans.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/kafka-kraft-quorum-ok.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/metallb-subnet-guard.sh`
  ...
  - … *1 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/och-housing-docker-services-default.sh`
  - L2: `# transport-watchdog: image only; rollouts map to deploy/api-gateway (see rebuild-och-images-and-rollout.sh).`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/och-kafka-event-topics-from-proto.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/och-sequential-rollout.sh`
  - L8: `#     och_kubectl() { kctl "$@"; }`
  ...
  - … *1 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/patch-kafka-external-host.sh`
  - L44: `RAW=$(kubectl run och-resolve-kafka-host --rm -i --restart=Never --image=busybox:1.36 -n off-campus-housing-tracker -- \`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/perf/build-canonical-bundle.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/preflight-kafka-k8s-rollout.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rebuild-all-housing-images-k3s.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rebuild-och-images-and-rollout.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rebuild-traffic-control-stack.sh`
  - L11: `exec "$ROOT/scripts/rebuild-och-images-and-rollout.sh"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/recycle-och-postgres-compose.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/restore-external-postgres-from-backup.sh`
  - L44: `och_terminate_db_sessions() {`
  - L58: `och_terminate_db_sessions "$port" "$db"`
  - L66: `och_terminate_db_sessions "$port" "$db"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rollout-deferred-after-kafka-tls.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rollout-restart-och-after-pool-tuning.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rollout-restart-och-full-stack.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - … *10 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/service-tls-alias-guard.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/setup-new-colima-cluster.sh`
  - L82: `if ! och_assert_metallb_pool_coherent "$METALLB_POOL"; then`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/slo/check-error-budget.js`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/tls-k8s-secrets-expiry.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/validate-kafka-stack-contract.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-deletion-flow.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-cluster.sh`
  ...
  - … *1 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-event-topic-partitions.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-kraft-e2e.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-tls-sans.sh`
  - L104: `done < <(och_kafka_emit_san_verify_dns_specs "$NS" "$REPLICAS")`
  - L120: `done < <(och_kafka_metallb_external_lb_ips_lines "$NS" "$REPLICAS")`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-network-coherence.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-proto-events-topics.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-proto-topic-alignment.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/wait-for-all-services-ready.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/wait-for-docker-compose-kafka-strict-ready.sh`
  - L6: `#   REPO_ROOT, ENV_PREFIX (default dev), OCH_KAFKA_TOPIC_SUFFIX (optional)`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/api-gateway-resources.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/cron-jobs-env-fix.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/dev-termination-and-strategy.yaml`
  - L7: `namespace: off-campus-housing-tracker`
  - L26: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/disk-pressure-tolerations.yaml`
  - L7: `namespace: off-campus-housing-tracker`
  - L20: `namespace: off-campus-housing-tracker`
  - L33: `namespace: off-campus-housing-tracker`
  - L46: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/e2e-high-cap-mode-env.yaml`
  - L8: `namespace: off-campus-housing-tracker`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-analytics-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-api-gateway.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-auth-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-listings-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-python-ai-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-records-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/envfrom-shopping-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/fix-api-gateway-probes.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/gateway-traffic-shaper-cluster-weight.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/hpa-api-gateway-single-replica.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/listings-analytics-sync-env.yaml`
  - L6: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/pgbouncer-image.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/pgbouncer-strategic.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/probes-records-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/replicas-api-gateway.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/replicas-auth-service.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/replicas-rest.yaml`
  - L5: `namespace: off-campus-housing-tracker`
  - L13: `namespace: off-campus-housing-tracker`
  ...
  - L45: `namespace: off-campus-housing-tracker`
  - L53: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/shopping-service-image.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/patches/webapp-local-image-pull.yaml`
  - L7: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/pods/postgres-postinit-debugger.yaml`
  - L5: `namespace: off-campus-housing-tracker`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/pvc/pgbackups-pvc.yaml`
  - L5: `namespace: off-campus-housing-tracker`
...
**Hits:** 41 (capped per file in scanner)
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/overlays/dev/ingress.yaml`
  ...
  - L56: `number: 4020`
  - L63: `number: 4020`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/smoke-api-gateway.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/edge-readiness-gate.sh`
...
**Hits:** 237 (capped per file in scanner)
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/infra/k8s/kafka-certs/README.md`
  - L24: `HOUSING_NS=off-campus-housing-tracker bash scripts/verify-kafka-tls-sans.sh`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/apply-kafka-kraft-staged.sh`
  - L11: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/auth-outbox-replay.sh`
  - L11: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/bring-up-external-infra.sh`
  - L38: `HOUSING_NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/chaos-kafka-alignment-stochastic.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/chaos-kafka-broker.sh`
  - L16: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/chaos-metallb-kafka-lb.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/check-kafka-config-drift.sh`
  - L12: `NS="${1:-${HOUSING_NS:-off-campus-housing-tracker}}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/canary-pod-stability.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/hydrate-certs-for-ci.sh`
  - L14: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/k6-smoke-incluster.sh`
  - L6: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/post-deploy-verify.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/smoke-api-gateway.sh`
  ...
  - L6: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ci/verify-k8s-images.sh`
  - L18: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/cleanup-kafka-ops-cronjob-pods.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-ready-for-preflight.sh`
  - L131: `_KNS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/ensure-strict-tls-mtls-preflight.sh`
  - L14: `HOUSING_NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/export-kafka-ca-metric.sh`
  - L9: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/golden-snapshot-verify.sh`
  - L19: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/k8s-diagnose-restarts.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-after-rollout-verify-brokers.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-auto-heal-inter-broker-tls.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-clean-slate.sh`
  - L9: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-onboarding-reset.sh`
  - L8: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-quorum-stable.sh`
  - L13: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-refresh-tls-from-lb.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-runtime-sync.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/kafka-sync-metallb.sh`
  - L12: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/lib/protocol-verification.sh`
  - L342: `# SNI validation: QUIC with off-campus-housing.test = definitive proof traffic belongs to our domain (no background noise).`
  - L349: `[[ "$sni_total" -gt 0 ]] && echo "  OK: $label QUIC SNI off-campus-housing.test: $sni_total packets (definitive proof traffic to our domain)"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/k6-edge-load-diagnostics.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/run-k6-all-services.sh`
  - L8: `#   BASE_URL              default https://off-campus-housing.test:443 or :30443`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/run-k6-listings-concurrency-instrumented.sh`
  - L15: `export HOUSING_NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/load/run-k6-phases.sh`
  - L35: `echo "  ❌ Do not use raw IP for strict TLS. Use hostname (e.g. https://off-campus-housing.test:443) and K6_RESOLVE."`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/probe-kafka-kraft-listeners.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/rebuild-housing-colima.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-preflight-scale-and-all-suites.sh`
  ...
  - … *7 more in this file*
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/run-suite-with-packet-capture.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/tests/kafka-alignment-suite.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-caddy-http3-in-cluster.sh`
  ...
  - L74: `CURL_RESOLVE="off-campus-housing.test:443:${TARGET_IP}"`
  - L78: `CURL_RESOLVE="off-campus-housing.test:443:${_cluster_ip}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-cluster-kafka-three-brokers.sh`
  - L4: `#   HOUSING_NS=off-campus-housing-tracker (default)`
  - L7: `HOUSING_NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-housing-kafka-bootstrap.sh`
  - L7: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-cluster.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-kraft-advertised-listeners.sh`
  - L15: `NS="${1:-${HOUSING_NS:-off-campus-housing-tracker}}"`
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-kafka-no-static-advertised-env.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/verify-required-housing-pods.sh`
...
- `record-platform-och-preflight-kafka-kraft-certs-caddy-reference-20260409/scripts/wait-for-kafka-external-lb-ips.sh`
  - L6: `NS="${HOUSING_NS:-off-campus-housing-tracker}"`
