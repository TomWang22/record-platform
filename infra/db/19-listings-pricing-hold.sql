...
COMMENT ON COLUMN listings.listings.soft_hold_until IS 'When set and in the future, listing is on soft hold (hidden from marketplace search; reservation-mesh blocks new requests).';
