#!/usr/bin/env bash
# In-cluster HTTP smoke: api-gateway /healthz (port 4000). Requires kubectl + reachable api-gateway Service.
# Usage: HOUSING_NS=record-platform ./scripts/ci/smoke-api-gateway.sh
set -euo pipefail
