...
URL="https://record-platform.test:443${TEST_PATH}"
RESOLVE="record-platform.test:443:${TARGET_IP}"

echo "=== Compare H2 vs H3 for path: $TEST_PATH (resolve record-platform.test → $TARGET_IP) ==="
