#!/usr/bin/env bash
# Quick readiness diagnostics for a Deployment in record-platform.
# Usage: ./scripts/diagnose-rp-deployment.sh media-service
#        ./scripts/diagnose-rp-deployment.sh auth-service
set -euo pipefail
