...
function suggest(root) {
  switch (root) {
    ...
    case "Observability (Jaeger) not reachable":
      return "Prefer edge Jaeger: JAEGER_QUERY_BASE=https://record.test/jaeger (Caddy + QUERY_BASE_PATH). Else: kubectl -n observability port-forward svc/jaeger 16686:16686; make validate-observability.";
