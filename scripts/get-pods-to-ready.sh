...
for d in api-gateway auth-service records-service listings-service shopping-service messaging-service trust-service analytics-service media-service notification-service python-ai-service auction-monitor; do
