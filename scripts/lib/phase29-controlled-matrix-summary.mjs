/**
 * Phase 29D/E — controlled observability matrix summary and latency tables.
 */
...
export function writeMatrixArtifacts(outDir, rows, extra = {}) {
  ...
  const files = {
    'phase29-summary.json': { ...summary, ...extra, generated_at: new Date().toISOString() },
    'phase29-latency-by-protocol.json': summary.latency_by_protocol,
    'phase29-latency-by-case.json': summary.latency_by_case,
    'phase29-latency-by-gate.json': summary.latency_by_gate,
    'phase29-latency-outliers-top20.json': outliers,
  };
