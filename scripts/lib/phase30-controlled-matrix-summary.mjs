/**
 * Phase 30D/E — controlled observability matrix summary and latency tables.
 */
...
export function writeMatrixArtifacts(outDir, rows, extra = {}) {
  ...
  const files = {
    'phase30-summary.json': { ...summary, ...extra, generated_at: new Date().toISOString() },
    'phase30-latency-by-protocol.json': summary.latency_by_protocol,
    'phase30-latency-by-case.json': summary.latency_by_case,
    'phase30-latency-by-gate.json': summary.latency_by_gate,
    'phase30-latency-outliers-top20.json': outliers,
  };
