...
echo "Building caddy-with-tcpdump:dev (HTTP/3 + tcpdump, tshark, strace, htop)..."
docker build -t caddy-with-tcpdump:dev -f docker/caddy-with-debug-tools.Dockerfile . || { echo "Build failed."; exit 1; }
