...
function main() {
  ...
  if (publisherBlocked.length !== 0) {
    throw new Error(`publisher_blocked_count_not_0:${publisherBlocked.length}`);
  }
  if (executable.length !== 11) {
    throw new Error(`lifecycle_executable_count_not_11:${executable.length}`);
  }
