-- W2_DOMAIN_PLUS_OUTBOX (analytics): same-TX domain touch + outbox insert.
-- Outbox: analytics.outbox_events (canonical; auth uses auth.outbox_events only).
...
BEGIN;
INSERT INTO analytics.pgbench_domain_touch (id, touched_at, note)
VALUES (
...
INSERT INTO analytics.outbox_events (
