-- W2_DOMAIN_PLUS_OUTBOX (auction_monitor): same-TX domain touch + outbox insert.
-- Outbox: auction_monitor.outbox_events (canonical; auth uses auth.outbox_events only).
