-- W2_DOMAIN_PLUS_OUTBOX (media): same-TX domain touch + outbox insert.
-- Outbox: media.outbox_events (canonical; auth uses auth.outbox_events only).
...
INSERT INTO media.outbox_events (
