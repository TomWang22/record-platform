#!/usr/bin/env python3
"""
Phase 29G — disable-switch rollback drill after matrix/report generation.
...
OUT_JSON = Path("/tmp/phase29-disable-switch-rollback-drill.json")
NAMESPACE = os.getenv("PHASE28_K8S_NAMESPACE", "record-platform")
DEPLOY = os.getenv("PHASE28_K8S_DEPLOY", "python-ai-service")
