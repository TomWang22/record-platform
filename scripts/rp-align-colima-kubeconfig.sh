...
export RP_COLIMA_HOST_IP="${RP_COLIMA_HOST_IP:-${OCH_COLIMA_HOST_IP:-}}"
export RP_COLIMA_HOST_IP_FALLBACK="${RP_COLIMA_HOST_IP_FALLBACK:-${OCH_COLIMA_HOST_IP_FALLBACK:-192.168.64.7}}"
...
for kcfg in \
  ...
  if _och_kubectl_set_cluster_server "$kcfg" "$server"; then
    aligned=1
