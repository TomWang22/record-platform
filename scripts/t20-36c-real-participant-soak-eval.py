#!/usr/bin/env python3
"""T20.36C — Real-participant opt-in hybrid preview soak (artifact-gated)."""
...
def main() -> int:
    ...
    os.environ["T20_EVAL_OUT_DIR"] = "t20-36c-real-participant-eval"
    os.environ["T20_25D_WINDOWS"] = "8"
