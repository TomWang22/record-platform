...
BOOKING_K8S_NS="${BOOKING_K8S_NS:-record-platform}"
...
for _sec in edge-service-tls service-tls; do
...
BOOKING_GRPC_SNI="${BOOKING_GRPC_SNI:-booking-service.record-platform.svc.cluster.local}"
