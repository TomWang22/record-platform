...
#
# Env:
#   EDGE_HOST              default record-platform.test
#   NAMESPACE_INGRESS      default ingress-nginx  (caddy-h3 lives here, NOT record-platform)
...
EDGE_HOST="${EDGE_HOST:-record-platform.test}"
...
say "5) Caddy: deployment in ${NAMESPACE_INGRESS} (not record-platform)"
