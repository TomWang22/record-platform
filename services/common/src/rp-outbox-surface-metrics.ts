/**
 * Service-wide transactional outbox observability (RP).
 * Every HTTP service should call `initOchOutboxSurfaceMetrics` once at startup so Prometheus
 * always exposes `rp_outbox_supported` (1 = implements outbox + gauges live, 0 = none).
 */
