...
const MESSAGING_PORT = parseInt(process.env.MESSAGING_DB_PORT || process.env.PGPORT || '5434', 10)
...
describe('Messaging flow (integration)', () => {
  ...
  // Requires messaging.* schema on RP port 5434 (run ensure-messaging-schema.sh).
