...
class TestPercentageCohort(unittest.TestCase):
    ...
    def test_percent_fifty_includes_buckets_0_through_49(self) -> None:
        in_cohort = {
            0: "00000040-0000-4000-8000-000000000000",
            1: "0000002a-0000-4000-8000-000000000000",
            9: "5a68fe88-c134-4166-b145-57534a3656b9",
            ...
            25: "0000003b-0000-4000-8000-000000000000",
            30: "000000f4-0000-4000-8000-000000000000",
            40: "00000168-0000-4000-8000-000000000000",
        }
        out_cohort = {
            50: "0000017b-0000-4000-8000-000000000000",
            55: "0000001d-0000-4000-8000-000000000000",
        }
        for b, uid in in_cohort.items():
            self.assertEqual(percentage_bucket(uid), b)
            self.assertTrue(in_percentage_cohort(uid, 50))
        for b, uid in out_cohort.items():
            self.assertEqual(percentage_bucket(uid), b)
            self.assertFalse(in_percentage_cohort(uid, 50))

    def test_percent_seventy_five_includes_buckets_0_through_74(self) -> None:
        in_cohort = {
            0: "00000040-0000-4000-8000-000000000000",
            30: "000000f4-0000-4000-8000-000000000000",
            50: "0000017b-0000-4000-8000-000000000000",
            60: "00000051-0000-4000-8000-000000000000",
            74: "000000a6-0000-4000-8000-000000000000",
        }
        out_cohort = {
            75: "0000003e-0000-4000-8000-000000000000",
            80: "0000000d-0000-4000-8000-000000000000",
        }
        for b, uid in in_cohort.items():
            self.assertEqual(percentage_bucket(uid), b)
            self.assertTrue(in_percentage_cohort(uid, 75))
        for b, uid in out_cohort.items():
            self.assertEqual(percentage_bucket(uid), b)
            self.assertFalse(in_percentage_cohort(uid, 75))

    def test_percent_one_hundred_includes_all_buckets_0_through_99(self) -> None:
        samples = {
            0: "00000040-0000-4000-8000-000000000000",
            9: "5a68fe88-c134-4166-b145-57534a3656b9",
            50: "0000017b-0000-4000-8000-000000000000",
            75: "0000003e-0000-4000-8000-000000000000",
            90: "00000019-0000-4000-8000-000000000000",
            99: "000000bd-0000-4000-8000-000000000000",
        }
        for b, uid in samples.items():
            self.assertEqual(percentage_bucket(uid), b)
            self.assertTrue(in_percentage_cohort(uid, 100))
        # percent>100 clamped to 100
        uid = "000000bd-0000-4000-8000-000000000000"
        self.assertTrue(in_percentage_cohort(uid, 150))
