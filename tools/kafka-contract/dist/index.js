...
async function runValidate(args) {
    ...
    const configBase = {
        ...
        requireAutoCreateDisabled: !args.skipBrokerConfig &&
    ...
    if (args.certCheck || process.env.KAFKA_CONTRACT_CERT_MIN_DAYS) {
        ...
        const certPath = process.env.KAFKA_CONTRACT_BROKER_CERT_PEM ||
