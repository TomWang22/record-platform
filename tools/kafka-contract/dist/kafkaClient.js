...
export function loadSslFromEnv() {
    ...
    if (!caPath || !certPath || !keyPath) {
        throw new Error("KAFKA_SSL_ENABLED=true requires KAFKA_CA_CERT (or KAFKA_SSL_CA_PATH), KAFKA_CLIENT_CERT, KAFKA_CLIENT_KEY");
    }
    const base = {
...
export function createKafkaFromEnv() {
