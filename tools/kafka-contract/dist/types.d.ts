...
export type ValidationErrorType = "TOPIC_MISSING" | "PARTITION_MISMATCH" | "REPLICATION_TOO_LOW" | "NO_LEADER" | "UNDER_REPLICATED" | "UNEXPECTED_TOPIC" | "BROKER_CONFIG_INVALID" | "CERT_EXPIRING" | "RACK_AWARENESS_VIOLATION" | "PARTITION_SKEW" | "ROLLING_RESTART_UNSAFE" | "QUORUM_TOO_SMALL" | "MIN_ISR_VIOLATION";
