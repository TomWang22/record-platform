...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${API_GATEWAY_URL}/forum/posts/${postId}/attachments`, {
      method: 'POST',
      headers: {
    ...
    console.error('Failed to add post attachment:', error)
...
export async function GET(
  ...
  try {
    ...
    console.error('Failed to fetch post attachments:', error)
