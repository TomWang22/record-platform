        ...
        <div className="space-y-10 leading-relaxed">
          <section>
            ...
            <p className="text-gray-700">
              Record Platform provides record collecting, catalog intelligence, marketplace listing,
              pricing research, and observability tooling. This Privacy Policy describes how we
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              ...
              <li>Provide access to catalog intelligence, marketplace, and pricing tools</li>
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              to provide you with our services. If you delete your account, we will delete your
              personal information in accordance with our data retention policies, except where we
