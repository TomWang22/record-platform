        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using Record Platform ("the Service"), you accept and agree to be bound by the terms and 
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Permission is granted to temporarily use Record Platform for personal, non-commercial transitory viewing only. 
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              The Service and its original content, features, and functionality are owned by Record Platform and are 
              protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">7. Disclaimer</h2>
            <p className="text-gray-700 mb-4">
              The materials on Record Platform are provided on an 'as is' basis. Record Platform makes no warranties, 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">8. Limitations</h2>
            <p className="text-gray-700 mb-4">
              In no event shall Record Platform or its suppliers be liable for any damages (including, without limitation, 
              damages for loss of data or profit, or due to business interruption) arising out of the use or inability to 
              use the materials on Record Platform, even if Record Platform or a Record Platform authorized representative 
