...
import { captureScreenshot, waitForNoLoadingStates } from './helpers/screenshot-readiness'
...
test.describe('Sell/list UI flow screenshots', () => {
  ...
  test('sell workflow through publish and revisions', async ({ page, request }) => {
    ...
    await captureScreenshot(page, 'e2e/screenshots/authenticated/authenticated-sell-select-record.png')

    await recordOption.click()
    await captureScreenshot(page, 'e2e/screenshots/authenticated/authenticated-sell-media-upload.png')
    ...
    await captureScreenshot(page, 'e2e/screenshots/authenticated/authenticated-sell-pricing-shipping.png')
    ...
    await captureScreenshot(page, 'e2e/screenshots/authenticated/authenticated-sell-preview.png')
    ...
    const createdListingId = created!.id
    ...
    await captureScreenshot(
      page,
      'e2e/screenshots/authenticated/authenticated-listing-detail-with-image.png',
      { fullPage: true },
    )
